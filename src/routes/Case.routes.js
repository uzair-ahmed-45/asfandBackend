...
import { behavoir, caseNo, chiefComplaint, childhoodHistory, countTotalCases, diagnosis, generals, getCaseNo, gyaneHistory, labTests, mind, nature, pastHistory, patientCases, remedies, totalCases } from "../controllers/case.controller.js";
...
caseRouter.route('/patientCases').post(patientCases)
